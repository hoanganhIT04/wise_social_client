                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 no-pdd">
                                            <div class="checky-sec st2">
                                                <div class="fgt-sec">
                                                    <input type="checkbox" v-on:click="registerChackAllow()" :checked="this.registerTOS === true" name="cc" id="c2">
                                                    <label for="c2">
                                                        <span></span>
                                                    </label>
    ...
    export default {
        ...
        */
        ...
        methods: {
             ...
             * Validate function
             * 
             * Show msg error or edabke button register
            ...
            registerValidation() {
                ...
                if (this.registerCountry == '') {
                    ...
                    this.registerErrCountryMsg = '国 名は 3 文字以上である必要があります';
                } else {
