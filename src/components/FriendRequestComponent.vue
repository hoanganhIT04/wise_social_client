    ...
    export default {
        ...
        methods: {
            ...
            async listFriendRequest() {
                try {
                    const callAPI = await axios.get('http://localhost/wise_social_api/public/api/list-friend-request', {
            ...
            async accept(id) {
                try {
                    const callAPI = await axios.get('http://localhost/wise_social_api/public/api/accept', {
                        /************ Attach param for request here ***************/
                        headers: {
                            "Content-type" : "application/json",
                            "Authorization": "Bearer " + this.token
